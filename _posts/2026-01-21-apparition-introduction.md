...
I was essentially creating a way for malware to hide which abuses the way windows necessarily must behave
It was pretty fun, and I only hope this tool gets better
...
Professionally: Modern endpoint detection platforms are increasingly effective at identifying traditional malware delivery and persistence mechanisms. Commonly monitored signals include:
...
## Novel Techniques
### Volume Root ADS
Volume-root ADS survive directory deletion and evade many common enumeration workflows. However:
